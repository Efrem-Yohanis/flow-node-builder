...
export function PropertiesPanel({ selectedNode, onUpdateNode, onDeleteNode }: PropertiesPanelProps) {
  if (!selectedNode) {
    return (
      <div className="w-80 bg-card border-l border-border shadow-panel flex items-center justify-center">
  ...
  return (
    <div className="w-80 bg-card border-l border-border shadow-panel animate-fade-in">
      {/* Header */}
